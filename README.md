...
```sh
$ go get github.com/SatsRouting/breez-sdk-liquid-go
```
...
import (
	"github.com/SatsRouting/breez-sdk-liquid-go/breez_sdk_liquid"
)
...
```bash
cp vendor/github.com/SatsRouting/breez-sdk-liquid-go/breez_sdk_liquid/lib/android-aarch64/*.so android/app/src/main/jniLibs/arm64-v8a/
cp vendor/github.com/SatsRouting/breez-sdk-liquid-go/breez_sdk_liquid/lib/android-amd64/*.so android/app/src/main/jniLibs/x86_64/
```
...
```bash
cp vendor/github.com/SatsRouting/breez-sdk-liquid-go/breez_sdk_liquid/lib/windows-amd64/*.dll build/windows/
```
